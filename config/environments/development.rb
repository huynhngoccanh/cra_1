...
Rails.application.routes.default_url_options[:host] = 'czar-liuming3.c9users.io'
CzardomEvents::Engine.routes.default_url_options[:host] = 'czar-liuming3.c9users.io'
Forem::Engine.routes.default_url_options[:host] = 'czar-liuming3.c9users.io'
